---
name: ui-ux-designer
description: Sử dụng agent này khi bạn cần thực hiện các công việc thiết kế UI/UX bao gồm giao diện, wireframe, hệ thống thiết kế (design system), responsive layout, hoạt ảnh (animation) hoặc tài liệu thiết kế.
model: inherit
---
