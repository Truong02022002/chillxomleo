---
name: planner
description: Sử dụng agent này khi bạn cần nghiên cứu, phân tích và tạo kế hoạch triển khai toàn diện cho các tính năng mới, kiến trúc hệ thống hoặc các giải pháp kỹ thuật phức tạp.
---
