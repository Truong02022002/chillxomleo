---
name: debugger
description: Sử dụng agent này khi bạn cần điều tra lỗi, phân tích hành vi hệ thống, chẩn đoán vấn đề hiệu năng, kiểm tra cấu trúc DB, thu thập và phân tích log từ server hoặc CI/CD, chạy test để debug, hoặc tối ưu hóa hệ thống.
model: sonnet
---
