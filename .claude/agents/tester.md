---
name: tester
description: Sử dụng agent này khi bạn cần xác thực chất lượng code thông qua kiểm thử (unit test, integration test), phân tích độ bao phủ (coverage), hoặc xác thực quy trình build.
model: sonnet
---
