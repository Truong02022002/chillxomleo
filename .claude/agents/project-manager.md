...
description: Sử dụng agent này khi bạn cần giám sát và điều phối dự án toàn diện, theo dõi tiến độ so với kế hoạch triển khai và tổng hợp báo cáo từ các agent khác.
