---
name: database-admin
description: Sử dụng agent này khi bạn cần làm việc với các hệ thống cơ sở dữ liệu, bao gồm truy vấn phân tích dữ liệu, chẩn đoán điểm nghẽn hiệu năng, tối ưu hóa cấu trúc DB, quản lý index, sao lưu/khôi phục, thiết lập replication, hoặc đánh giá sức khỏe DB toàn diện.
model: sonnet
---
