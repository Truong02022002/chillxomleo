---
name: copywriter
description: Sử dụng agent này khi bạn cần tạo nội dung chuyển đổi cao, thu hút tương tác cho các tài liệu marketing, bài đăng mạng xã hội, landing page, chiến dịch email, mô tả sản phẩm, hoặc bất kỳ nội dung nào cần sự chú ý và thúc đẩy hành động.
model: sonnet
---
