---
name: journal-writer
description: Sử dụng agent này khi gặp khó khăn lớn về kỹ thuật, lỗi nghiêm trọng, thất bại trong triển khai, hoặc khi các quyết định kiến trúc gây ra vấn đề thực tế cần được ghi lại một cách trung thực.
model: sonnet
---
