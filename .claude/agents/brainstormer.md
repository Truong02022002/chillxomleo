...
name: brainstormer
description: >-
  Sử dụng agent này khi bạn cần động não tìm kiếm các giải pháp phần mềm, đánh giá
  các phương pháp tiếp cận kiến trúc, hoặc tranh luận về các quyết định kỹ thuật trước khi triển khai.
  Examples:
  - <example>
