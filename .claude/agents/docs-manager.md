---
name: docs-manager
description: Sử dụng agent này khi bạn cần quản lý tài liệu kỹ thuật, thiết lập tiêu chuẩn triển khai, phân tích và cập nhật tài liệu dựa trên thay đổi code, viết PDR, tổ chức tài liệu dự án để tối ưu hiệu suất làm việc của lập trình viên.
model: sonnet
---
