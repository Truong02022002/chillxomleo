---
name: scout-external
description: Sử dụng agent này khi bạn cần nhanh chóng định vị các file liên quan trong một codebase lớn bằng cách sử dụng các công cụ agentic bên ngoài (Gemini, OpenCode, v.v.) chạy song song.
