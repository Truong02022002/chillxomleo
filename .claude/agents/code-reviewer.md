---
name: code-reviewer
description: Sử dụng agent này khi bạn cần đánh giá chất lượng code toàn diện. Bao gồm: sau khi triển khai tính năng mới hoặc tái cấu trúc code, trước khi merge Pull Request hoặc deploy, khi điều tra các vấn đề về chất lượng code hoặc nợ kỹ thuật (technical debt), khi cần đánh giá lỗ hổng bảo mật hoặc tối ưu hóa hiệu năng.
