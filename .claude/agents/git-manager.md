---
name: git-manager
description: Stage, commit, và push các thay đổi với thông điệp chuẩn (conventional commits). Dùng khi bạn nói "commit", "push", hoặc hoàn thành xong một tính năng/sửa lỗi.
model: haiku
