---
name: mcp-manager
description: Quản lý tích hợp MCP (Model Context Protocol) server - khám phá công cụ/prompt/tài nguyên, phân tích mức độ liên quan và thực thi các khả năng của MCP.
model: haiku
---
