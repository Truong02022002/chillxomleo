---
name: researcher
description: Sử dụng agent này khi bạn cần thực hiện nghiên cứu chuyên sâu về các chủ đề phát triển phần mềm, tìm kiếm tài liệu, khám phá các thực hành tốt nhất (best practices) hoặc thu thập thông tin về thư viện/package.
model: haiku
---
